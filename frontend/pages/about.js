    ...
    <div className="absolute top-28 flex flex-col md:flex-row md:flex-wrap md:w-3/4 md:top-0 md:left-1/4 md:h-full">
      ...
      <div>
        ...
        <p>
          ...
          helpful so YOU don't have to be the one scrolling around google maps in desparation to find a good
          spot to eat and annoy your S/O in the process.
        </p>
      </div>
      ...
      <div>
        ...
        <ul>
          <li>
            The color: Green means go, red means don't, let's keep it simple. The site should mostly be green
            since I do the prevetting before I go to these places.
          </li>
          ...
          <li>
            Bathroom: Quoting the great Anthony Bourdain “I won’t eat in a restaurant with filthy bathrooms.
            ...
            refrigeration and work spaces look like.” Tip toeing around - its a bathroom - Where di you get
            this decor?
          </li>
        </ul>
      </div>
